...
- [deadpixel/roundtable-dashboard](https://github.com/deadpixel/roundtable-dashboard) 📇 ☁️ - Multi-model AI brainstorming MCP server: GPT-4o, Claude, Gemini & 200+ models discuss your question in parallel, then a moderator synthesizes the best answer. 13 tools including consult_council, review_code, debug_issue, and design_architecture. Streamable HTTP with OAuth 2.0 + PKCE.
